...
public class MonitorDatasourceController {
	...
	public ResponseEntity<DatasourceQueryResponse> monitorKonom(@RequestParam String tableName,
			@RequestParam String metricsName, @RequestParam long granularity, @RequestParam double threshold,
			@RequestParam boolean drop, @RequestHeader("X-KONOM-GROUPS") String group,
			@RequestHeader("X-AUTH-TOKEN") String authToken, @RequestHeader("X-KONOM-USER") String user) throws DatasourceNotFoundException {
