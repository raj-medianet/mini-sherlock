...
public class MonitorDatasource{
	...
	public DatasourceQueryResponse monitor(Datasource datasource, DatasourceQuerypayload payload, HttpHeaders headers, double threshold, boolean drop) {
	...
	private void sendAlert(List<DatasourceTimeseriesResult> result, String customMeasureOutputName, double threshold, boolean drop) {
